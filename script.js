...
sum2 = ((Math.pow(Math.E, Math.pow(-a, 2)))+(Math.pow(Math.E, Math.pow(-b, 2))))/2;
...
bf=x+length;
mid=(af+bf)/2;
x1 = ((bf-af)/6)*((Math.pow(Math.E, Math.pow(-af, 2)))+
(4*(Math.pow(Math.E, Math.pow(-mid, 2))))+(Math.pow(Math.E, Math.pow(-bf, 2))));
sum+= x1;
x+=length;
}
